...
For hg38, these hyper-stable methylated probes are incorporated in a data object `hg38UltraStableProbes`, and a function `addHyperStableFraction` is provided to calculate this and add as a column to the sampleTable for filtering.
