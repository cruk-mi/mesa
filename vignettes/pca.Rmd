...
knitr::opts_chunk$set(
  ...
  comment   = "#>",
  dev       = "png",
  dev.args  = list(type = "cairo")   # <- headless-safe
)
if (!capabilities("X11")) options(bitmapType = "cairo")  # <- extra guard
...
```{r}
PCAplots4 <- plotPCA(pca2, exampleTumourNormal, colour = c("patient", "age"), shape = "tumour") 
