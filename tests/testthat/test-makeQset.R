test_that("Making a hg19 qseaSet", {
  ...
  sampleTable <- data.frame(
    ...
    file_name = c(
      system.file("extdata", "NSCLC_MeDIP_1N_fst_chr_20_21_22.bam", package = "MEDIPSData", mustWork = TRUE),
...
test_that("Making a hg19 qseaSet with qsea coverage method", {
  ...
  sampleTable <- data.frame(
    ...
    group = c("Test1", "Test2"),
    file_name = c(
      system.file("extdata", "NSCLC_MeDIP_2N_fst_chr_20_21_22.bam", package = "MEDIPSData", mustWork = TRUE),
      system.file("extdata", "NSCLC_MeDIP_2T_fst_chr_20_21_22.bam", package = "MEDIPSData", mustWork = TRUE)
    ),
    input_file = c(
      system.file("extdata", "NSCLC_MeDIP_3N_fst_chr_20_21_22.bam", package = "MEDIPSData", mustWork = TRUE),
